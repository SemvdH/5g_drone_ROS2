...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d86a6f
    m_timestamp = 0;
    // m_uptime com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2892d68
    m_uptime = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5ab956d7
    m_type = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@3646a422
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@750e2b97
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@3e27aa33
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@750e2b97
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e385cce
    m_temperature_board = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@2ddc9a9f
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@298a5e20
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a7f1f10
    m_ram_usage = 0;
    // m_ram_total com.eprosima.idl.parser.typecode.PrimitiveTypeCode@46cdf8bd
    m_ram_total = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@f0c8a99
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@f0c8a99
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@f0c8a99
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@740cae06
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@740cae06
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@740cae06
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@740cae06
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@740cae06
