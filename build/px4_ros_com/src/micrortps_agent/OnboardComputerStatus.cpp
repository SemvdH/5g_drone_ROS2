...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@16b2bb0c
    m_timestamp = 0;
    // m_uptime com.eprosima.idl.parser.typecode.PrimitiveTypeCode@327af41b
    m_uptime = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6cb6decd
    m_type = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@c7045b9
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@f99f5e0
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@6aa61224
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@f99f5e0
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board com.eprosima.idl.parser.typecode.PrimitiveTypeCode@30bce90b
    m_temperature_board = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@3e6f3f28
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@7e19ebf0
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2474f125
    m_ram_usage = 0;
    // m_ram_total com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7357a011
    m_ram_total = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@3406472c
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@3406472c
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@3406472c
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@5717c37
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@5717c37
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@5717c37
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@5717c37
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@5717c37
