...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6d5620ce
    m_timestamp = 0;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@311bf055
    m_type = 0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@642a7222
    m_mode = 0;
    // m_flow_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7d322cad
    m_flow_control = false;
    // m_forwarding com.eprosima.idl.parser.typecode.PrimitiveTypeCode@21be3395
    m_forwarding = false;
    // m_mavlink_v2 com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4f49f6af
    m_mavlink_v2 = false;
    // m_ftp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78452606
    m_ftp = false;
    // m_streams com.eprosima.idl.parser.typecode.PrimitiveTypeCode@147e2ae7
    m_streams = 0;
    // m_data_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@448c8166
    m_data_rate = 0.0;
    // m_rate_multiplier com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4470fbd6
    m_rate_multiplier = 0.0;
    // m_tx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@15d49048
    m_tx_rate_avg = 0.0;
    // m_tx_error_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7098b907
    m_tx_error_rate_avg = 0.0;
    // m_tx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@503f91c3
    m_tx_message_count = 0;
    // m_tx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13526e59
    m_tx_buffer_overruns = 0;
    // m_rx_rate_avg com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2235eaab
    m_rx_rate_avg = 0.0;
    // m_rx_message_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17503f6b
    m_rx_message_count = 0;
    // m_rx_message_lost_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3bcd05cb
    m_rx_message_lost_count = 0;
    // m_rx_buffer_overruns com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b6d844d
    m_rx_buffer_overruns = 0;
    // m_rx_parse_errors com.eprosima.idl.parser.typecode.PrimitiveTypeCode@36804139
    m_rx_parse_errors = 0;
    // m_rx_packet_drop_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20bd8be5
    m_rx_packet_drop_count = 0;
    // m_rx_message_lost_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@730d2164
    m_rx_message_lost_rate = 0.0;
    // m_heartbeat_type_antenna_tracker com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24959ca4
    m_heartbeat_type_antenna_tracker = false;
    // m_heartbeat_type_gcs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10289886
    m_heartbeat_type_gcs = false;
    // m_heartbeat_type_onboard_controller com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c86dbc5
    m_heartbeat_type_onboard_controller = false;
    // m_heartbeat_type_gimbal com.eprosima.idl.parser.typecode.PrimitiveTypeCode@461ad730
    m_heartbeat_type_gimbal = false;
    // m_heartbeat_type_adsb com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ee203eb
    m_heartbeat_type_adsb = false;
    // m_heartbeat_type_camera com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a5a4e19
    m_heartbeat_type_camera = false;
    // m_heartbeat_type_parachute com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7068e664
    m_heartbeat_type_parachute = false;
    // m_heartbeat_component_telemetry_radio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60db1c0e
    m_heartbeat_component_telemetry_radio = false;
    // m_heartbeat_component_log com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e78b6a5
    m_heartbeat_component_log = false;
    // m_heartbeat_component_osd com.eprosima.idl.parser.typecode.PrimitiveTypeCode@769a1df5
    m_heartbeat_component_osd = false;
    // m_heartbeat_component_obstacle_avoidance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@41f69e84
    m_heartbeat_component_obstacle_avoidance = false;
    // m_heartbeat_component_vio com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7975d1d8
    m_heartbeat_component_vio = false;
    // m_heartbeat_component_pairing_manager com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2438dcd
    m_heartbeat_component_pairing_manager = false;
    // m_heartbeat_component_udp_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24105dc5
    m_heartbeat_component_udp_bridge = false;
    // m_heartbeat_component_uart_bridge com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5167f57d
    m_heartbeat_component_uart_bridge = false;
    // m_avoidance_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64b0598
    m_avoidance_system_healthy = false;
    // m_parachute_system_healthy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18f8cd79
