...
/*!
 * @file SensorCombinedPubSubTypes.h
...
#ifndef _PX4_MSGS_MSG_SENSORCOMBINED_PUBSUBTYPES_H_
#define _PX4_MSGS_MSG_SENSORCOMBINED_PUBSUBTYPES_H_
...
#error Generated SensorCombined is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace px4_msgs
{
    namespace msg
    {
        ...
        /*!
         * @brief This class represents the TopicDataType of the type SensorCombined defined by the user in the IDL file.
         * @ingroup SENSORCOMBINED
         */
        class SensorCombinedPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
            typedef SensorCombined type;

            eProsima_user_DllExport SensorCombinedPubSubType();

            eProsima_user_DllExport virtual ~SensorCombinedPubSubType();
...
#endif // _PX4_MSGS_MSG_SENSORCOMBINED_PUBSUBTYPES_H_