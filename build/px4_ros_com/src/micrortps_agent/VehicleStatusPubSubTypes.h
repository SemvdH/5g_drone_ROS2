...
/*!
 * @file VehicleStatusPubSubTypes.h
...
#ifndef _PX4_MSGS_MSG_VEHICLESTATUS_PUBSUBTYPES_H_
#define _PX4_MSGS_MSG_VEHICLESTATUS_PUBSUBTYPES_H_
...
#error Generated VehicleStatus is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace px4_msgs
{
    namespace msg
    {
        ...
        /*!
         * @brief This class represents the TopicDataType of the type VehicleStatus defined by the user in the IDL file.
         * @ingroup VEHICLESTATUS
         */
        class VehicleStatusPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
            typedef VehicleStatus type;

            eProsima_user_DllExport VehicleStatusPubSubType();
...
#endif // _PX4_MSGS_MSG_VEHICLESTATUS_PUBSUBTYPES_H_