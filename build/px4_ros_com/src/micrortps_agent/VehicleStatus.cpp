...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69997e9d
    m_timestamp = 0;
    // m_nav_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@793be5ca
    m_nav_state = 0;
    // m_nav_state_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2df9b86
    m_nav_state_timestamp = 0;
    // m_arming_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37654521
    m_arming_state = 0;
    // m_hil_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@15aab8c6
    m_hil_state = 0;
    // m_failsafe com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33990a0c
    m_failsafe = false;
    // m_failsafe_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4de4b452
    m_failsafe_timestamp = 0;
    // m_system_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50b5ac82
    m_system_type = 0;
    // m_system_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@101952da
    m_system_id = 0;
    // m_component_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6babf3bf
    m_component_id = 0;
    // m_vehicle_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3059cbc
    m_vehicle_type = 0;
    // m_is_vtol com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7ea9e1e2
    m_is_vtol = false;
    // m_is_vtol_tailsitter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@24fcf36f
    m_is_vtol_tailsitter = false;
    // m_vtol_fw_permanent_stab com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10feca44
    m_vtol_fw_permanent_stab = false;
    // m_in_transition_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3fb1549b
    m_in_transition_mode = false;
    // m_in_transition_to_fw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ea6147e
    m_in_transition_to_fw = false;
    // m_rc_signal_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d02f94e
    m_rc_signal_lost = false;
    // m_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2b48a640
    m_data_link_lost = false;
    // m_data_link_lost_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e683a3e
    m_data_link_lost_counter = 0;
    // m_high_latency_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2053d869
    m_high_latency_data_link_lost = false;
    // m_engine_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a419da4
    m_engine_failure = false;
    // m_mission_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14555e0a
    m_mission_failure = false;
    // m_geofence_violated com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4bb33f74
    m_geofence_violated = false;
    // m_failure_detector_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@759d26fb
    m_failure_detector_status = 0;
    // m_onboard_control_sensors_present com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c73951
    m_onboard_control_sensors_present = 0;
    // m_onboard_control_sensors_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d5c822d
    m_onboard_control_sensors_enabled = 0;
    // m_onboard_control_sensors_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f46426d
    m_onboard_control_sensors_health = 0;
    // m_latest_arming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@73700b80
    m_latest_arming_reason = 0;
    // m_latest_disarming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c7b90e
    m_latest_disarming_reason = 0;
    // m_armed_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10d307f1
    m_armed_time = 0;
    // m_takeoff_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d5b6aac
    m_takeoff_time = 0;
