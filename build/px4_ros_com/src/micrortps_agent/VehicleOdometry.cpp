...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7d8995e
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@130d63be
    m_timestamp_sample = 0;
    // m_local_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6aeb35e6
    m_local_frame = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1283bb96
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74f0ea28
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f6efaab
    m_z = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@3c19aaa5
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@3c19aaa5
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@3349e9bb
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@409bf450
    m_velocity_frame = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38d8f54a
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49e53c76
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@351d00c0
    m_vz = 0.0;
    // m_rollspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a3b5b47
    m_rollspeed = 0.0;
    // m_pitchspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b699ef
    m_pitchspeed = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18078bef
    m_yawspeed = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@3349e9bb
    memset(&m_velocity_covariance, 0, (21) * 4);
    // m_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@145f66e3
    m_reset_counter = 0;
