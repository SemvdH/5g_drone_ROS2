...
/*!
 * @file VehicleTrajectoryBezierPubSubTypes.h
...
#ifndef _PX4_MSGS_MSG_VEHICLETRAJECTORYBEZIER_PUBSUBTYPES_H_
#define _PX4_MSGS_MSG_VEHICLETRAJECTORYBEZIER_PUBSUBTYPES_H_
...
#error Generated VehicleTrajectoryBezier is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace px4_msgs
{
    namespace msg
    {
        ...
        /*!
         * @brief This class represents the TopicDataType of the type VehicleTrajectoryBezier defined by the user in the IDL file.
         * @ingroup VEHICLETRAJECTORYBEZIER
         */
        class VehicleTrajectoryBezierPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
            typedef VehicleTrajectoryBezier type;

            eProsima_user_DllExport VehicleTrajectoryBezierPubSubType();

            eProsima_user_DllExport virtual ~VehicleTrajectoryBezierPubSubType();
...
#endif // _PX4_MSGS_MSG_VEHICLETRAJECTORYBEZIER_PUBSUBTYPES_H_