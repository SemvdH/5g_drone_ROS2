...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7671cb68
    m_timestamp = 0;
    // m_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49dc7102
    m_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b8ca3c8
    m_type = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@68c72235
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10959ece
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3a6bb9bf
    m_vz = 0.0;
    // m_velocity_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@34f7cfd9
    m_velocity_valid = false;
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@65f095f8
    m_velocity_frame = 0;
    // m_alt_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59af0466
    m_alt_valid = false;
    // m_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e6ef8ad
    m_lat = 0.0;
    // m_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@346d61be
    m_lon = 0.0;
    // m_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55536d9e
    m_alt = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@747edf66
    m_yaw = 0.0;
    // m_yaw_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d1cfad4
    m_yaw_valid = false;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62230c58
    m_yawspeed = 0.0;
    // m_yawspeed_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2cd2a21f
    m_yawspeed_valid = false;
    // m_landing_gear com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e55dd0c
    m_landing_gear = 0;
    // m_loiter_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74455848
    m_loiter_radius = 0.0;
    // m_loiter_direction com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e7edb54
    m_loiter_direction = 0;
    // m_acceptance_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@378542de
    m_acceptance_radius = 0.0;
    // m_cruising_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3738449f
    m_cruising_speed = 0.0;
    // m_cruising_throttle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69e1dd28
    m_cruising_throttle = 0.0;
    // m_disable_weather_vane com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11bd0f3b
