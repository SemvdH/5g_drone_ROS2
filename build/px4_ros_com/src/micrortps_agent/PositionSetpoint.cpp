...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e1d27ba
    m_timestamp = 0;
    // m_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61d6015a
    m_valid = false;
    // m_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2525ff7e
    m_type = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@524d6d96
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@152aa092
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44a7bfbc
    m_vz = 0.0;
    // m_velocity_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ef37659
    m_velocity_valid = false;
    // m_velocity_frame com.eprosima.idl.parser.typecode.PrimitiveTypeCode@776b83cc
    m_velocity_frame = 0;
    // m_alt_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37858383
    m_alt_valid = false;
    // m_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e268090
    m_lat = 0.0;
    // m_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1bb266b3
    m_lon = 0.0;
    // m_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@306cf3ea
    m_alt = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2beee7ff
    m_yaw = 0.0;
    // m_yaw_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5136d012
    m_yaw_valid = false;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5939a379
    m_yawspeed = 0.0;
    // m_yawspeed_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e1de817
    m_yawspeed_valid = false;
    // m_landing_gear com.eprosima.idl.parser.typecode.PrimitiveTypeCode@52102734
    m_landing_gear = 0;
    // m_loiter_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3541cb24
    m_loiter_radius = 0.0;
    // m_loiter_direction com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2177849e
    m_loiter_direction = 0;
    // m_acceptance_radius com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40cb8df7
    m_acceptance_radius = 0.0;
    // m_cruising_speed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13b13b5d
    m_cruising_speed = 0.0;
    // m_cruising_throttle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2892dae4
    m_cruising_throttle = 0.0;
    // m_disable_weather_vane com.eprosima.idl.parser.typecode.PrimitiveTypeCode@355ce81c
