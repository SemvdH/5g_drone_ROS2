...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e4487af
    m_timestamp = 0;
    // m_sensor_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6aaceffd
    m_sensor_id = 0;
    // m_pixel_flow_x_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c86b9e3
    m_pixel_flow_x_integral = 0.0;
    // m_pixel_flow_y_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10aa41f2
    m_pixel_flow_y_integral = 0.0;
    // m_gyro_x_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3af9c5b7
    m_gyro_x_rate_integral = 0.0;
    // m_gyro_y_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37271612
    m_gyro_y_rate_integral = 0.0;
    // m_gyro_z_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ed7f8b4
    m_gyro_z_rate_integral = 0.0;
    // m_ground_distance_m com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c309d4d
    m_ground_distance_m = 0.0;
    // m_integration_timespan com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38102d01
    m_integration_timespan = 0;
    // m_time_since_last_sonar_update com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37883b97
    m_time_since_last_sonar_update = 0;
    // m_frame_count_since_last_readout com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ab778a
    m_frame_count_since_last_readout = 0;
    // m_gyro_temperature com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e3958e7
    m_gyro_temperature = 0;
    // m_quality com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77f80c04
    m_quality = 0;
    // m_max_flow_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dac5ef
    m_max_flow_rate = 0.0;
    // m_min_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c90e579
    m_min_ground_distance = 0.0;
    // m_max_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@58ea606c
    m_max_ground_distance = 0.0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f45df59
    m_mode = 0;
