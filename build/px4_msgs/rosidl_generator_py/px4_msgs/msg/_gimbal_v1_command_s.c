...
bool px4_msgs__msg__gimbal_v1_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._gimbal_v1_command.GimbalV1Command", full_classname_dest, 47) == 0);
  }
  px4_msgs__msg__GimbalV1Command * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__gimbal_v1_command__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GimbalV1Command */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._gimbal_v1_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GimbalV1Command");
  ...
  px4_msgs__msg__GimbalV1Command * ros_message = (px4_msgs__msg__GimbalV1Command *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
