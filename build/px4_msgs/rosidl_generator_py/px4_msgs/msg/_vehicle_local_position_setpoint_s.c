...
bool px4_msgs__msg__vehicle_local_position_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._vehicle_local_position_setpoint.VehicleLocalPositionSetpoint", full_classname_dest, 74) == 0);
  }
  px4_msgs__msg__VehicleLocalPositionSetpoint * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of VehicleLocalPositionSetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._vehicle_local_position_setpoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleLocalPositionSetpoint");
