...
class Metaclass_ObstacleDistanceFused(type):
    """Metaclass of message 'ObstacleDistanceFused'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__obstacle_distance_fused
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__obstacle_distance_fused
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__obstacle_distance_fused
            cls._TYPE_SUPPORT = module.type_support_msg__msg__obstacle_distance_fused
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__obstacle_distance_fused
    ...
    def MAV_FRAME_GLOBAL(self):
        ...
        return Metaclass_ObstacleDistanceFused.__constants['MAV_FRAME_GLOBAL']

    @property
    def MAV_FRAME_LOCAL_NED(self):
        """Message constant 'MAV_FRAME_LOCAL_NED'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_FRAME_LOCAL_NED']

    @property
    def MAV_FRAME_BODY_FRD(self):
        """Message constant 'MAV_FRAME_BODY_FRD'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_FRAME_BODY_FRD']

    @property
    def MAV_DISTANCE_SENSOR_LASER(self):
        """Message constant 'MAV_DISTANCE_SENSOR_LASER'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_DISTANCE_SENSOR_LASER']

    @property
    def MAV_DISTANCE_SENSOR_ULTRASOUND(self):
        """Message constant 'MAV_DISTANCE_SENSOR_ULTRASOUND'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_DISTANCE_SENSOR_ULTRASOUND']

    @property
    def MAV_DISTANCE_SENSOR_INFRARED(self):
        """Message constant 'MAV_DISTANCE_SENSOR_INFRARED'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_DISTANCE_SENSOR_INFRARED']

    @property
    def MAV_DISTANCE_SENSOR_RADAR(self):
        """Message constant 'MAV_DISTANCE_SENSOR_RADAR'."""
        return Metaclass_ObstacleDistanceFused.__constants['MAV_DISTANCE_SENSOR_RADAR']


class ObstacleDistanceFused(metaclass=Metaclass_ObstacleDistanceFused):
    """
    Message class 'ObstacleDistanceFused'.
