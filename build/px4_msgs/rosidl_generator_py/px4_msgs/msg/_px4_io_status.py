...
class Px4IoStatus(metaclass=Metaclass_Px4IoStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.status_safety_off = kwargs.get('status_safety_off', bool())
    ...
    def __eq__(self, other):
        ...
        if self.status_rc_sumd != other.status_rc_sumd:
            return False
        if self.status_safety_off != other.status_safety_off:
            return False
    ...
    @builtins.property
    def status_safety_off(self):
        """Message field 'status_safety_off'."""
        return self._status_safety_off

    @status_safety_off.setter
    def status_safety_off(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'status_safety_off' field must be of type 'bool'"
        self._status_safety_off = value
