...
bool px4_msgs__msg__vehicle_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._vehicle_odometry.VehicleOdometry", full_classname_dest, 46) == 0);
  }
  px4_msgs__msg__VehicleOdometry * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of VehicleOdometry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._vehicle_odometry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleOdometry");
