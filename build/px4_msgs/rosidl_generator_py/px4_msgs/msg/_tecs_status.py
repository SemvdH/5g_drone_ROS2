...
class TecsStatus(metaclass=Metaclass_TecsStatus):
    ...
    def altitude_filtered(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'altitude_filtered' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def true_airspeed_innovation(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'true_airspeed_innovation' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy_error(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy_error' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def energy_distribution_error(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'energy_distribution_error' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy_rate_error(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy_rate_error' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def energy_distribution_rate_error(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'energy_distribution_rate_error' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy_balance(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy_balance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy_sp(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy_sp' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def total_energy_balance_sp(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'total_energy_balance_sp' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
