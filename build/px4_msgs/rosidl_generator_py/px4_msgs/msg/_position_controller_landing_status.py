...
class PositionControllerLandingStatus(metaclass=Metaclass_PositionControllerLandingStatus):
    ...
    def horizontal_slope_displacement(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'horizontal_slope_displacement' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def slope_angle_rad(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'slope_angle_rad' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def flare_length(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'flare_length' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
