...
class Metaclass_ActuatorOutputsSim(type):
    """Metaclass of message 'ActuatorOutputsSim'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.ActuatorOutputsSim')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__actuator_outputs_sim
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__actuator_outputs_sim
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__actuator_outputs_sim
            cls._TYPE_SUPPORT = module.type_support_msg__msg__actuator_outputs_sim
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__actuator_outputs_sim
    ...
    def NUM_ACTUATOR_OUTPUTS(self):
        ...
        return Metaclass_ActuatorOutputsSim.__constants['NUM_ACTUATOR_OUTPUTS']

    @property
    def NUM_ACTUATOR_OUTPUT_GROUPS(self):
        """Message constant 'NUM_ACTUATOR_OUTPUT_GROUPS'."""
        return Metaclass_ActuatorOutputsSim.__constants['NUM_ACTUATOR_OUTPUT_GROUPS']


class ActuatorOutputsSim(metaclass=Metaclass_ActuatorOutputsSim):
    """
    Message class 'ActuatorOutputsSim'.
