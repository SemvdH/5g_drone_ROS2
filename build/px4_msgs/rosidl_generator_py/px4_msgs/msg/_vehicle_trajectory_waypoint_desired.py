...
class Metaclass_VehicleTrajectoryWaypointDesired(type):
    """Metaclass of message 'VehicleTrajectoryWaypointDesired'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.VehicleTrajectoryWaypointDesired')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vehicle_trajectory_waypoint_desired
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vehicle_trajectory_waypoint_desired
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vehicle_trajectory_waypoint_desired
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vehicle_trajectory_waypoint_desired
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vehicle_trajectory_waypoint_desired
    ...
    def MAV_TRAJECTORY_REPRESENTATION_WAYPOINTS(self):
        ...
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['MAV_TRAJECTORY_REPRESENTATION_WAYPOINTS']

    @property
    def POINT_0(self):
        """Message constant 'POINT_0'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['POINT_0']

    @property
    def POINT_1(self):
        """Message constant 'POINT_1'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['POINT_1']

    @property
    def POINT_2(self):
        """Message constant 'POINT_2'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['POINT_2']

    @property
    def POINT_3(self):
        """Message constant 'POINT_3'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['POINT_3']

    @property
    def POINT_4(self):
        """Message constant 'POINT_4'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['POINT_4']

    @property
    def NUMBER_POINTS(self):
        """Message constant 'NUMBER_POINTS'."""
        return Metaclass_VehicleTrajectoryWaypointDesired.__constants['NUMBER_POINTS']


class VehicleTrajectoryWaypointDesired(metaclass=Metaclass_VehicleTrajectoryWaypointDesired):
    """
    Message class 'VehicleTrajectoryWaypointDesired'.
