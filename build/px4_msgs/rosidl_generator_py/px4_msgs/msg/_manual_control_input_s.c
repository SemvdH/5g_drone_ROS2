...
bool px4_msgs__msg__manual_control_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._manual_control_input.ManualControlInput", full_classname_dest, 53) == 0);
  }
  px4_msgs__msg__ManualControlInput * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__manual_control_input__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ManualControlInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._manual_control_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ManualControlInput");
  ...
  px4_msgs__msg__ManualControlInput * ros_message = (px4_msgs__msg__ManualControlInput *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
