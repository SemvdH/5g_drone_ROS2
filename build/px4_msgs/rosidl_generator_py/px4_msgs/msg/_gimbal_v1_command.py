...
class Metaclass_GimbalV1Command(type):
    ...
    def VEHICLE_CMD_RESULT_ACCEPTED(self):
        ...
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_ACCEPTED']

    @property
    def VEHICLE_CMD_RESULT_TEMPORARILY_REJECTED(self):
        """Message constant 'VEHICLE_CMD_RESULT_TEMPORARILY_REJECTED'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_TEMPORARILY_REJECTED']

    @property
    def VEHICLE_CMD_RESULT_DENIED(self):
        """Message constant 'VEHICLE_CMD_RESULT_DENIED'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_DENIED']

    @property
    def VEHICLE_CMD_RESULT_UNSUPPORTED(self):
        """Message constant 'VEHICLE_CMD_RESULT_UNSUPPORTED'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_UNSUPPORTED']

    @property
    def VEHICLE_CMD_RESULT_FAILED(self):
        """Message constant 'VEHICLE_CMD_RESULT_FAILED'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_FAILED']

    @property
    def VEHICLE_CMD_RESULT_IN_PROGRESS(self):
        """Message constant 'VEHICLE_CMD_RESULT_IN_PROGRESS'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_IN_PROGRESS']

    @property
    def VEHICLE_CMD_RESULT_ENUM_END(self):
        """Message constant 'VEHICLE_CMD_RESULT_ENUM_END'."""
        return Metaclass_GimbalV1Command.__constants['VEHICLE_CMD_RESULT_ENUM_END']
