...
bool px4_msgs__msg__sensor_combined__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._sensor_combined.SensorCombined", full_classname_dest, 44) == 0);
  }
  px4_msgs__msg__SensorCombined * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of SensorCombined */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._sensor_combined");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorCombined");
