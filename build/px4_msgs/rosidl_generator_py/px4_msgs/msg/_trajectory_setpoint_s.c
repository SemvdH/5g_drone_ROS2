...
bool px4_msgs__msg__trajectory_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._trajectory_setpoint.TrajectorySetpoint", full_classname_dest, 52) == 0);
  }
  px4_msgs__msg__TrajectorySetpoint * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of TrajectorySetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._trajectory_setpoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectorySetpoint");
