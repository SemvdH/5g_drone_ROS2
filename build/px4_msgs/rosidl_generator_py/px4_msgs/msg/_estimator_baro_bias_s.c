...
bool px4_msgs__msg__estimator_baro_bias__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_baro_bias.EstimatorBaroBias", full_classname_dest, 51) == 0);
  }
  px4_msgs__msg__EstimatorBaroBias * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_baro_bias__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorBaroBias */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_baro_bias");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorBaroBias");
  ...
  px4_msgs__msg__EstimatorBaroBias * ros_message = (px4_msgs__msg__EstimatorBaroBias *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
