...
bool px4_msgs__msg__sensor_gyro__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._sensor_gyro.SensorGyro", full_classname_dest, 36) == 0);
  }
  px4_msgs__msg__SensorGyro * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // samples
    ...
    assert(PyLong_Check(field));
    ros_message->samples = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SensorGyro */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._sensor_gyro");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorGyro");
  ...
  {  // samples
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->samples);
    {
