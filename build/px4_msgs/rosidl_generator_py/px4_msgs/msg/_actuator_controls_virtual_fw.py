...
class Metaclass_ActuatorControlsVirtualFw(type):
    ...
    def GROUP_INDEX_MANUAL_PASSTHROUGH(self):
        ...
        return Metaclass_ActuatorControlsVirtualFw.__constants['GROUP_INDEX_MANUAL_PASSTHROUGH']

    @property
    def GROUP_INDEX_PAYLOAD(self):
        """Message constant 'GROUP_INDEX_PAYLOAD'."""
        return Metaclass_ActuatorControlsVirtualFw.__constants['GROUP_INDEX_PAYLOAD']
