...
bool px4_msgs__msg__obstacle_distance_fused__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._obstacle_distance_fused.ObstacleDistanceFused", full_classname_dest, 59) == 0);
  }
  px4_msgs__msg__ObstacleDistanceFused * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__obstacle_distance_fused__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ObstacleDistanceFused */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._obstacle_distance_fused");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstacleDistanceFused");
  ...
  px4_msgs__msg__ObstacleDistanceFused * ros_message = (px4_msgs__msg__ObstacleDistanceFused *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
