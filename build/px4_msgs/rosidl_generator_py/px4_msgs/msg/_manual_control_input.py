...
class Metaclass_ManualControlInput(type):
    """Metaclass of message 'ManualControlInput'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.ManualControlInput')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__manual_control_input
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__manual_control_input
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__manual_control_input
            cls._TYPE_SUPPORT = module.type_support_msg__msg__manual_control_input
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__manual_control_input
    ...
    def SOURCE_UNKNOWN(self):
        ...
        return Metaclass_ManualControlInput.__constants['SOURCE_UNKNOWN']

    @property
    def SOURCE_RC(self):
        """Message constant 'SOURCE_RC'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_RC']

    @property
    def SOURCE_MAVLINK_0(self):
        """Message constant 'SOURCE_MAVLINK_0'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_0']

    @property
    def SOURCE_MAVLINK_1(self):
        """Message constant 'SOURCE_MAVLINK_1'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_1']

    @property
    def SOURCE_MAVLINK_2(self):
        """Message constant 'SOURCE_MAVLINK_2'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_2']

    @property
    def SOURCE_MAVLINK_3(self):
        """Message constant 'SOURCE_MAVLINK_3'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_3']

    @property
    def SOURCE_MAVLINK_4(self):
        """Message constant 'SOURCE_MAVLINK_4'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_4']

    @property
    def SOURCE_MAVLINK_5(self):
        """Message constant 'SOURCE_MAVLINK_5'."""
        return Metaclass_ManualControlInput.__constants['SOURCE_MAVLINK_5']


class ManualControlInput(metaclass=Metaclass_ManualControlInput):
    """
    Message class 'ManualControlInput'.
