...
class Metaclass_ActuatorControlsVirtualMc(type):
    ...
    def GROUP_INDEX_MANUAL_PASSTHROUGH(self):
        ...
        return Metaclass_ActuatorControlsVirtualMc.__constants['GROUP_INDEX_MANUAL_PASSTHROUGH']

    @property
    def GROUP_INDEX_PAYLOAD(self):
        """Message constant 'GROUP_INDEX_PAYLOAD'."""
        return Metaclass_ActuatorControlsVirtualMc.__constants['GROUP_INDEX_PAYLOAD']
