...
#include "px4_msgs/msg/detail/estimator_innovation_variances__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::EstimatorInnovationVariances & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::EstimatorInnovationVariances & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_EstimatorInnovationVariances(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorInnovationVariances *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::EstimatorInnovationVariances *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorInnovationVariances__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorInnovationVariances *>(
...
static size_t _EstimatorInnovationVariances__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_EstimatorInnovationVariances(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EstimatorInnovationVariances__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _EstimatorInnovationVariances__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorInnovationVariances__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorInnovationVariances__handle;
}
