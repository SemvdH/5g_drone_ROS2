...
#include "px4_msgs/msg/detail/estimator_innovation_test_ratios__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::EstimatorInnovationTestRatios & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::EstimatorInnovationTestRatios & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_EstimatorInnovationTestRatios(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorInnovationTestRatios *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::EstimatorInnovationTestRatios *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorInnovationTestRatios__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorInnovationTestRatios *>(
...
static size_t _EstimatorInnovationTestRatios__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EstimatorInnovationTestRatios(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EstimatorInnovationTestRatios__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _EstimatorInnovationTestRatios__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorInnovationTestRatios__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorInnovationTestRatios__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, EstimatorInnovationTestRatios)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorInnovationTestRatios__handle;
}
