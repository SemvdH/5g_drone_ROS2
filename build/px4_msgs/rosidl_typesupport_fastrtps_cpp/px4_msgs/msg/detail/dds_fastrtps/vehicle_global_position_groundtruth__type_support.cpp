...
#include "px4_msgs/msg/detail/vehicle_global_position_groundtruth__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::VehicleGlobalPositionGroundtruth & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::VehicleGlobalPositionGroundtruth & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_VehicleGlobalPositionGroundtruth(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VehicleGlobalPositionGroundtruth *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::VehicleGlobalPositionGroundtruth *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleGlobalPositionGroundtruth__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VehicleGlobalPositionGroundtruth *>(
...
static size_t _VehicleGlobalPositionGroundtruth__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehicleGlobalPositionGroundtruth(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehicleGlobalPositionGroundtruth__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _VehicleGlobalPositionGroundtruth__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleGlobalPositionGroundtruth__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_VehicleGlobalPositionGroundtruth__handle;
}
