...
#include "px4_msgs/msg/detail/sensors_status_baro__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::SensorsStatusBaro & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::SensorsStatusBaro & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_SensorsStatusBaro(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::SensorsStatusBaro *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::SensorsStatusBaro *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SensorsStatusBaro__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::SensorsStatusBaro *>(
...
static size_t _SensorsStatusBaro__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SensorsStatusBaro(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SensorsStatusBaro__callbacks = {
  "px4_msgs::msg",
  "SensorsStatusBaro",
...
static rosidl_message_type_support_t _SensorsStatusBaro__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SensorsStatusBaro__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_SensorsStatusBaro__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, SensorsStatusBaro)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_SensorsStatusBaro__handle;
}
