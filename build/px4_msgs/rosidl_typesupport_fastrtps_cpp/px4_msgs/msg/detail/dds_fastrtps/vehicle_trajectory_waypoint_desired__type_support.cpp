...
static size_t _VehicleTrajectoryWaypointDesired__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_VehicleTrajectoryWaypointDesired(full_bounded, is_plain, 0);
