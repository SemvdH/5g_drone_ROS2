...
px4_msgs__msg__VehicleAttitudeGroundtruth__create()
{
  ...
  px4_msgs__msg__VehicleAttitudeGroundtruth * msg = (px4_msgs__msg__VehicleAttitudeGroundtruth *)allocator.allocate(sizeof(px4_msgs__msg__VehicleAttitudeGroundtruth), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence__init(px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleAttitudeGroundtruth *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__VehicleAttitudeGroundtruth), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence * array = (px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence__are_equal(const px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence * lhs, const px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__VehicleAttitudeGroundtruth__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__VehicleAttitudeGroundtruth__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__VehicleAttitudeGroundtruth);
    px4_msgs__msg__VehicleAttitudeGroundtruth * data =
      (px4_msgs__msg__VehicleAttitudeGroundtruth *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__VehicleAttitudeGroundtruth__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__VehicleAttitudeGroundtruth__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__VehicleAttitudeGroundtruth__copy(
