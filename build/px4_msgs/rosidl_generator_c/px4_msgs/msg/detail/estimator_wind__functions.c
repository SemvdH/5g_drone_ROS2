...
px4_msgs__msg__EstimatorWind__create()
{
  ...
  px4_msgs__msg__EstimatorWind * msg = (px4_msgs__msg__EstimatorWind *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorWind), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorWind__Sequence__init(px4_msgs__msg__EstimatorWind__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorWind *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__EstimatorWind), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__EstimatorWind__Sequence * array = (px4_msgs__msg__EstimatorWind__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__EstimatorWind__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorWind__Sequence__are_equal(const px4_msgs__msg__EstimatorWind__Sequence * lhs, const px4_msgs__msg__EstimatorWind__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__EstimatorWind__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__EstimatorWind__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__EstimatorWind);
    px4_msgs__msg__EstimatorWind * data =
      (px4_msgs__msg__EstimatorWind *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__EstimatorWind__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__EstimatorWind__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__EstimatorWind__copy(
