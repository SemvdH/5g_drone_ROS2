...
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_X_VARIANCE = 0
};

/// Constant 'COVARIANCE_MATRIX_Y_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_Y_VARIANCE = 6
};

/// Constant 'COVARIANCE_MATRIX_Z_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_Z_VARIANCE = 11
};

/// Constant 'COVARIANCE_MATRIX_ROLL_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_ROLL_VARIANCE = 15
};

/// Constant 'COVARIANCE_MATRIX_PITCH_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_PITCH_VARIANCE = 18
};

/// Constant 'COVARIANCE_MATRIX_YAW_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_YAW_VARIANCE = 20
};

/// Constant 'COVARIANCE_MATRIX_VX_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_VX_VARIANCE = 0
};

/// Constant 'COVARIANCE_MATRIX_VY_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_VY_VARIANCE = 6
};

/// Constant 'COVARIANCE_MATRIX_VZ_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_VZ_VARIANCE = 11
};

/// Constant 'COVARIANCE_MATRIX_ROLLRATE_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_ROLLRATE_VARIANCE = 15
};

/// Constant 'COVARIANCE_MATRIX_PITCHRATE_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_PITCHRATE_VARIANCE = 18
};

/// Constant 'COVARIANCE_MATRIX_YAWRATE_VARIANCE'.
enum
{
  px4_msgs__msg__EstimatorOdometry__COVARIANCE_MATRIX_YAWRATE_VARIANCE = 20
};
...
enum
{
  px4_msgs__msg__EstimatorOdometry__LOCAL_FRAME_NED = 0
};
...
enum
{
  px4_msgs__msg__EstimatorOdometry__LOCAL_FRAME_FRD = 1
};
...
enum
{
  px4_msgs__msg__EstimatorOdometry__LOCAL_FRAME_OTHER = 2
};
...
enum
{
  px4_msgs__msg__EstimatorOdometry__BODY_FRAME_FRD = 3
};
