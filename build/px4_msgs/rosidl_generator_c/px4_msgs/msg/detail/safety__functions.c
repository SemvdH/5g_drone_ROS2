...
px4_msgs__msg__Safety__are_equal(const px4_msgs__msg__Safety * lhs, const px4_msgs__msg__Safety * rhs)
{
  ...
  // safety_switch_available
  if (lhs->safety_switch_available != rhs->safety_switch_available) {
    return false;
  }
  // safety_off
  ...
  px4_msgs__msg__Safety * output)
{
  ...
  // safety_switch_available
  output->safety_switch_available = input->safety_switch_available;
  // safety_off
...
px4_msgs__msg__Safety__create()
{
  ...
  px4_msgs__msg__Safety * msg = (px4_msgs__msg__Safety *)allocator.allocate(sizeof(px4_msgs__msg__Safety), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__Safety__Sequence__init(px4_msgs__msg__Safety__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__Safety *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__Safety), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__Safety__Sequence * array = (px4_msgs__msg__Safety__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__Safety__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
px4_msgs__msg__Safety__Sequence__are_equal(const px4_msgs__msg__Safety__Sequence * lhs, const px4_msgs__msg__Safety__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__Safety__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__Safety__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__Safety);
    px4_msgs__msg__Safety * data =
      (px4_msgs__msg__Safety *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__Safety__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__Safety__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__Safety__copy(
