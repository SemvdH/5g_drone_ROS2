...
px4_msgs__msg__ActuatorControlsStatus__create()
{
  ...
  memset(msg, 0, sizeof(px4_msgs__msg__ActuatorControlsStatus));
  bool success = px4_msgs__msg__ActuatorControlsStatus__init(msg);
  if (!success) {
...
px4_msgs__msg__ActuatorControlsStatus__destroy(px4_msgs__msg__ActuatorControlsStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4_msgs__msg__ActuatorControlsStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
px4_msgs__msg__ActuatorControlsStatus__Sequence__init(px4_msgs__msg__ActuatorControlsStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__ActuatorControlsStatus * data = NULL;

  if (size) {
    data = (px4_msgs__msg__ActuatorControlsStatus *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__ActuatorControlsStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4_msgs__msg__ActuatorControlsStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4_msgs__msg__ActuatorControlsStatus__fini(&data[i - 1]);
      }
...
px4_msgs__msg__ActuatorControlsStatus__Sequence__fini(px4_msgs__msg__ActuatorControlsStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4_msgs__msg__ActuatorControlsStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__ActuatorControlsStatus__Sequence * array = (px4_msgs__msg__ActuatorControlsStatus__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__ActuatorControlsStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4_msgs__msg__ActuatorControlsStatus__Sequence__init(array, size);
  if (!success) {
...
px4_msgs__msg__ActuatorControlsStatus__Sequence__destroy(px4_msgs__msg__ActuatorControlsStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4_msgs__msg__ActuatorControlsStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
px4_msgs__msg__ActuatorControlsStatus__Sequence__are_equal(const px4_msgs__msg__ActuatorControlsStatus__Sequence * lhs, const px4_msgs__msg__ActuatorControlsStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs__msg__ActuatorControlsStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4_msgs__msg__ActuatorControlsStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs__msg__ActuatorControlsStatus);
    px4_msgs__msg__ActuatorControlsStatus * data =
      (px4_msgs__msg__ActuatorControlsStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__ActuatorControlsStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__ActuatorControlsStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs__msg__ActuatorControlsStatus__copy(
