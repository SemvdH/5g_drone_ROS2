...
/**
  * Sets the GPS co-ordinates of the vehicle local origin (0,0,0) position. |Empty|Empty|Empty|Empty|Latitude|Longitude|Altitude|
 */
enum
{
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_ACCEPTED = 0
};
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_TEMPORARILY_REJECTED = 1
};
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_DENIED = 2
};
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_UNSUPPORTED = 3
};
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_FAILED = 4
};
...
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_IN_PROGRESS = 5
};

/// Constant 'VEHICLE_CMD_RESULT_ENUM_END'.
enum
{
  px4_msgs__msg__GimbalV1Command__VEHICLE_CMD_RESULT_ENUM_END = 6
};
...
/**
  * Continuous zoom up/down until stopped
 */
enum
{
...
/**
  * Zoom value as proportion of full camera range
 */
enum
{
