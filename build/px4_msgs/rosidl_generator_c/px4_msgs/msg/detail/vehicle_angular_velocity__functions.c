...
px4_msgs__msg__VehicleAngularVelocity__create()
{
  ...
  px4_msgs__msg__VehicleAngularVelocity * msg = (px4_msgs__msg__VehicleAngularVelocity *)allocator.allocate(sizeof(px4_msgs__msg__VehicleAngularVelocity), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__VehicleAngularVelocity__Sequence__init(px4_msgs__msg__VehicleAngularVelocity__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__VehicleAngularVelocity *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__VehicleAngularVelocity), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__VehicleAngularVelocity__Sequence * array = (px4_msgs__msg__VehicleAngularVelocity__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__VehicleAngularVelocity__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
