...
enum
{
  px4_msgs__msg__ActuatorControls__NUM_ACTUATOR_CONTROLS = 8
};
...
enum
{
  px4_msgs__msg__ActuatorControls__GROUP_INDEX_MANUAL_PASSTHROUGH = 3
};

/// Constant 'GROUP_INDEX_PAYLOAD'.
enum
{
  px4_msgs__msg__ActuatorControls__GROUP_INDEX_PAYLOAD = 6
};
