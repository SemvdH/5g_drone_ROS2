...
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_X_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_Y_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_Z_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_ROLL_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_PITCH_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_YAW_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_VX_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_VY_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_VZ_VARIANCE;
template<typename ContainerAllocator>
...
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::COVARIANCE_MATRIX_YAWRATE_VARIANCE;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::LOCAL_FRAME_NED;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::LOCAL_FRAME_FRD;
template<typename ContainerAllocator>
constexpr uint8_t EstimatorVisualOdometryAligned_<ContainerAllocator>::LOCAL_FRAME_OTHER;
template<typename ContainerAllocator>
