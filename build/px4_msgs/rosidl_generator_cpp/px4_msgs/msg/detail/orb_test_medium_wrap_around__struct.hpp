...
#ifndef PX4_MSGS__MSG__DETAIL__ORB_TEST_MEDIUM_WRAP_AROUND__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ORB_TEST_MEDIUM_WRAP_AROUND__STRUCT_HPP_
...
struct OrbTestMediumWrapAround_
{
  ...
  explicit OrbTestMediumWrapAround_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit OrbTestMediumWrapAround_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : junk(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__DETAIL__ORB_TEST_MEDIUM_WRAP_AROUND__STRUCT_HPP_
