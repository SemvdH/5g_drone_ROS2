...
template<typename ContainerAllocator>
constexpr uint8_t ActuatorControls_<ContainerAllocator>::GROUP_INDEX_MANUAL_PASSTHROUGH;
template<typename ContainerAllocator>
constexpr uint8_t ActuatorControls_<ContainerAllocator>::GROUP_INDEX_PAYLOAD;
