...
#ifndef PX4_MSGS__MSG__DETAIL__SENSORS_STATUS_BARO__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__SENSORS_STATUS_BARO__TRAITS_HPP_
...
inline std::string to_yaml(const SensorsStatusBaro & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::SensorsStatusBaro & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::SensorsStatusBaro & msg)
{
  return px4_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4_msgs::msg::SensorsStatusBaro>()
{
  return "px4_msgs::msg::SensorsStatusBaro";
}

template<>
inline const char * name<px4_msgs::msg::SensorsStatusBaro>()
{
  return "px4_msgs/msg/SensorsStatusBaro";
}

template<>
struct has_fixed_size<px4_msgs::msg::SensorsStatusBaro>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4_msgs::msg::SensorsStatusBaro>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4_msgs::msg::SensorsStatusBaro>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__SENSORS_STATUS_BARO__TRAITS_HPP_
