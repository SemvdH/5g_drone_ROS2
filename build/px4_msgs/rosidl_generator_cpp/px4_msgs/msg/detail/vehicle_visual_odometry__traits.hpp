...
inline void to_flow_style_yaml(
  const VehicleVisualOdometry & msg,
  std::ostream & out)
{
  out << "{";
  // member: timestamp
...
inline std::string to_yaml(const VehicleVisualOdometry & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::VehicleVisualOdometry & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::VehicleVisualOdometry & msg)
{
