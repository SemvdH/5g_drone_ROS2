  ...
  std::ostream & out)
{
  ...
  {
    out << "reject_mag_x: ";
    rosidl_generator_traits::value_to_yaml(msg.reject_mag_x, out);
    out << ", ";
  }
  ...
  {
    out << "reject_mag_y: ";
    rosidl_generator_traits::value_to_yaml(msg.reject_mag_y, out);
    out << ", ";
  }
  ...
  {
    out << "reject_mag_z: ";
    rosidl_generator_traits::value_to_yaml(msg.reject_mag_z, out);
    out << ", ";
  }
