...
public:
  ...
  : msg_(msg)
  {}
  Init_Px4IoStatus_alarm_pwm_error status_safety_off(::px4_msgs::msg::Px4IoStatus::_status_safety_off_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Px4IoStatus_status_safety_off status_rc_sumd(::px4_msgs::msg::Px4IoStatus::_status_rc_sumd_type arg)
  {
