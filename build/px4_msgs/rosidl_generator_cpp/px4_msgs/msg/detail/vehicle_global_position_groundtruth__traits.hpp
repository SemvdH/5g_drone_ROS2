...
#ifndef PX4_MSGS__MSG__DETAIL__VEHICLE_GLOBAL_POSITION_GROUNDTRUTH__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__VEHICLE_GLOBAL_POSITION_GROUNDTRUTH__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const VehicleGlobalPositionGroundtruth & msg,
  std::ostream & out)
{
  out << "{";
  // member: timestamp
...
inline std::string to_yaml(const VehicleGlobalPositionGroundtruth & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::VehicleGlobalPositionGroundtruth & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::VehicleGlobalPositionGroundtruth & msg)
{
  return px4_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4_msgs::msg::VehicleGlobalPositionGroundtruth>()
{
  return "px4_msgs::msg::VehicleGlobalPositionGroundtruth";
}

template<>
inline const char * name<px4_msgs::msg::VehicleGlobalPositionGroundtruth>()
{
  return "px4_msgs/msg/VehicleGlobalPositionGroundtruth";
}

template<>
struct has_fixed_size<px4_msgs::msg::VehicleGlobalPositionGroundtruth>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4_msgs::msg::VehicleGlobalPositionGroundtruth>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4_msgs::msg::VehicleGlobalPositionGroundtruth>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__VEHICLE_GLOBAL_POSITION_GROUNDTRUTH__TRAITS_HPP_
