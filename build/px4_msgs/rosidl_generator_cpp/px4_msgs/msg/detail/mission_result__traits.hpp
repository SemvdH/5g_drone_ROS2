  ...
  std::ostream & out)
{
  ...
  {
    out << "stay_in_failsafe: ";
    rosidl_generator_traits::value_to_yaml(msg.stay_in_failsafe, out);
    out << ", ";
  }

  // member: flight_termination
  {
    out << "flight_termination: ";
    rosidl_generator_traits::value_to_yaml(msg.flight_termination, out);
    out << ", ";
  }
