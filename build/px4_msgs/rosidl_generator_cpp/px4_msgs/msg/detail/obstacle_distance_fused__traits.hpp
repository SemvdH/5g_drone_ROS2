...
#ifndef PX4_MSGS__MSG__DETAIL__OBSTACLE_DISTANCE_FUSED__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__OBSTACLE_DISTANCE_FUSED__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const ObstacleDistanceFused & msg,
  std::ostream & out)
{
  out << "{";
  // member: timestamp
...
inline std::string to_yaml(const ObstacleDistanceFused & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::ObstacleDistanceFused & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::ObstacleDistanceFused & msg)
{
...
template<>
inline const char * name<px4_msgs::msg::ObstacleDistanceFused>()
{
  return "px4_msgs/msg/ObstacleDistanceFused";
}
...
template<>
struct is_message<px4_msgs::msg::ObstacleDistanceFused>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__OBSTACLE_DISTANCE_FUSED__TRAITS_HPP_
