  ...
  std::ostream & out)
{
  ...
  {
    out << "altitude_filtered: ";
    rosidl_generator_traits::value_to_yaml(msg.altitude_filtered, out);
    out << ", ";
  }
  ...
  {
    out << "true_airspeed_innovation: ";
    rosidl_generator_traits::value_to_yaml(msg.true_airspeed_innovation, out);
    out << ", ";
  }

  // member: total_energy_error
  {
    out << "total_energy_error: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy_error, out);
    out << ", ";
  }

  // member: energy_distribution_error
  {
    out << "energy_distribution_error: ";
    rosidl_generator_traits::value_to_yaml(msg.energy_distribution_error, out);
    out << ", ";
  }

  // member: total_energy_rate_error
  {
    out << "total_energy_rate_error: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy_rate_error, out);
    out << ", ";
  }

  // member: energy_distribution_rate_error
  {
    out << "energy_distribution_rate_error: ";
    rosidl_generator_traits::value_to_yaml(msg.energy_distribution_rate_error, out);
    out << ", ";
  }
  ...
  {
    out << "total_energy: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy, out);
    out << ", ";
  }
  ...
  {
    out << "total_energy_balance: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy_balance, out);
    out << ", ";
  }
  ...
  {
    out << "total_energy_sp: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy_sp, out);
    out << ", ";
  }
  ...
  {
    out << "total_energy_balance_sp: ";
    rosidl_generator_traits::value_to_yaml(msg.total_energy_balance_sp, out);
    out << ", ";
  }
