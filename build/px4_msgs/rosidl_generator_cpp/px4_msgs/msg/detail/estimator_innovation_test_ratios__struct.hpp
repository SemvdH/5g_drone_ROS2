...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorInnovationTestRatios __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorInnovationTestRatios __declspec(deprecated)
#endif
...
struct EstimatorInnovationTestRatios_
{
  using Type = EstimatorInnovationTestRatios_<ContainerAllocator>;

  explicit EstimatorInnovationTestRatios_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorInnovationTestRatios_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : gps_hvel(_alloc),
    gps_hpos(_alloc),
    ev_hvel(_alloc),
    ev_hpos(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorInnovationTestRatios
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorInnovationTestRatios
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationTestRatios_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorInnovationTestRatios_ & other) const
  {
...
using EstimatorInnovationTestRatios =
  px4_msgs::msg::EstimatorInnovationTestRatios_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__STRUCT_HPP_
