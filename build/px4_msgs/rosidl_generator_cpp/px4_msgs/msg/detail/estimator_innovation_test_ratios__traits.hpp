...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const EstimatorInnovationTestRatios & msg,
  std::ostream & out)
{
  out << "{";
  // member: timestamp
...
inline std::string to_yaml(const EstimatorInnovationTestRatios & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::EstimatorInnovationTestRatios & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::EstimatorInnovationTestRatios & msg)
{
...
template<>
inline const char * name<px4_msgs::msg::EstimatorInnovationTestRatios>()
{
  return "px4_msgs/msg/EstimatorInnovationTestRatios";
}
...
template<>
struct is_message<px4_msgs::msg::EstimatorInnovationTestRatios>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_TEST_RATIOS__TRAITS_HPP_
