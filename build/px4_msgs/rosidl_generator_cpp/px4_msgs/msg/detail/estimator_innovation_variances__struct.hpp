...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_VARIANCES__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_VARIANCES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorInnovationVariances __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorInnovationVariances __declspec(deprecated)
#endif
...
{
  using Type = EstimatorInnovationVariances_<ContainerAllocator>;

  explicit EstimatorInnovationVariances_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorInnovationVariances_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : gps_hvel(_alloc),
    gps_hpos(_alloc),
    ev_hvel(_alloc),
    ev_hpos(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorInnovationVariances
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorInnovationVariances
    std::shared_ptr<px4_msgs::msg::EstimatorInnovationVariances_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorInnovationVariances_ & other) const
  {
...
using EstimatorInnovationVariances =
  px4_msgs::msg::EstimatorInnovationVariances_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_INNOVATION_VARIANCES__STRUCT_HPP_
