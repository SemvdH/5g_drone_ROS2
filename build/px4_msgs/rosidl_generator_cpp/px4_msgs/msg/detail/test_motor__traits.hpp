  ...
  std::ostream & out)
{
  ...
  {
    out << "motor_number: ";
    rosidl_generator_traits::value_to_yaml(msg.motor_number, out);
    out << ", ";
  }
  ...
  {
    out << "driver_instance: ";
    rosidl_generator_traits::value_to_yaml(msg.driver_instance, out);
  }
  out << "}";
...
inline std::string to_yaml(const TestMotor & msg, bool use_flow_style = false)
{
