...
void VehicleAttitudeGroundtruth__rosidl_typesupport_introspection_c__VehicleAttitudeGroundtruth_init_function(
...
void VehicleAttitudeGroundtruth__rosidl_typesupport_introspection_c__VehicleAttitudeGroundtruth_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleAttitudeGroundtruth__rosidl_typesupport_introspection_c__VehicleAttitudeGroundtruth_message_members = {
  ...
  VehicleAttitudeGroundtruth__rosidl_typesupport_introspection_c__VehicleAttitudeGroundtruth_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleAttitudeGroundtruth__rosidl_typesupport_introspection_c__VehicleAttitudeGroundtruth_fini_function  // function to terminate message instance (will not free memory)
};
