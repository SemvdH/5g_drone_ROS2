...
void ActuatorControlsStatus1__rosidl_typesupport_introspection_c__ActuatorControlsStatus1_init_function(
...
void ActuatorControlsStatus1__rosidl_typesupport_introspection_c__ActuatorControlsStatus1_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ActuatorControlsStatus1__rosidl_typesupport_introspection_c__ActuatorControlsStatus1_message_members = {
  ...
  ActuatorControlsStatus1__rosidl_typesupport_introspection_c__ActuatorControlsStatus1_init_function,  // function to initialize message memory (memory has to be allocated)
  ActuatorControlsStatus1__rosidl_typesupport_introspection_c__ActuatorControlsStatus1_fini_function  // function to terminate message instance (will not free memory)
};
