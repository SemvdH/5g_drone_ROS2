...
size_t px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__size_function__ControlAllocatorStatus__allocated_torque(
...
const void * px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_torque(
...
void * px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_torque(
...
void px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__fetch_function__ControlAllocatorStatus__allocated_torque(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_torque(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__assign_function__ControlAllocatorStatus__allocated_torque(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_torque(untyped_member, index));
  const float * value =
...
size_t px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__size_function__ControlAllocatorStatus__allocated_thrust(
  const void * untyped_member)
{
  (void)untyped_member;
  return 3;
...
const void * px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_thrust(
  const void * untyped_member, size_t index)
{
  const float * member =
    (const float *)(untyped_member);
...
void * px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_thrust(
  void * untyped_member, size_t index)
{
  float * member =
    (float *)(untyped_member);
...
void px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__fetch_function__ControlAllocatorStatus__allocated_thrust(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_thrust(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__assign_function__ControlAllocatorStatus__allocated_thrust(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_thrust(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__ControlAllocatorStatus_message_member_array[8] = {
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__ControlAllocatorStatus, allocated_torque),  // bytes offset in struct
    NULL,  // default value
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__size_function__ControlAllocatorStatus__allocated_torque,  // size() function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_torque,  // get_const(index) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_torque,  // get(index) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__fetch_function__ControlAllocatorStatus__allocated_torque,  // fetch(index, &value) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__assign_function__ControlAllocatorStatus__allocated_torque,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__ControlAllocatorStatus, allocated_thrust),  // bytes offset in struct
    NULL,  // default value
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__size_function__ControlAllocatorStatus__allocated_thrust,  // size() function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_const_function__ControlAllocatorStatus__allocated_thrust,  // get_const(index) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__get_function__ControlAllocatorStatus__allocated_thrust,  // get(index) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__fetch_function__ControlAllocatorStatus__allocated_thrust,  // fetch(index, &value) function pointer
    px4_msgs__msg__ControlAllocatorStatus__rosidl_typesupport_introspection_c__assign_function__ControlAllocatorStatus__allocated_thrust,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
