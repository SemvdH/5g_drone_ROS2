...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__VehicleImu__rosidl_typesupport_introspection_c__VehicleImu_message_member_array[11] = {
  {
    "timestamp",  // name
