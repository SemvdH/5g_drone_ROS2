...
size_t px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__size_function__VehicleLocalPositionSetpoint__jerk(
  const void * untyped_member)
{
  (void)untyped_member;
  return 3;
...
const void * px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_const_function__VehicleLocalPositionSetpoint__jerk(
  const void * untyped_member, size_t index)
{
  const float * member =
    (const float *)(untyped_member);
...
void * px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_function__VehicleLocalPositionSetpoint__jerk(
  void * untyped_member, size_t index)
{
  float * member =
    (float *)(untyped_member);
...
void px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__fetch_function__VehicleLocalPositionSetpoint__jerk(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_const_function__VehicleLocalPositionSetpoint__jerk(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__assign_function__VehicleLocalPositionSetpoint__jerk(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_function__VehicleLocalPositionSetpoint__jerk(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__VehicleLocalPositionSetpoint_message_member_array[12] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__VehicleLocalPositionSetpoint, jerk),  // bytes offset in struct
    NULL,  // default value
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__size_function__VehicleLocalPositionSetpoint__jerk,  // size() function pointer
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_const_function__VehicleLocalPositionSetpoint__jerk,  // get_const(index) function pointer
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__get_function__VehicleLocalPositionSetpoint__jerk,  // get(index) function pointer
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__fetch_function__VehicleLocalPositionSetpoint__jerk,  // fetch(index, &value) function pointer
    px4_msgs__msg__VehicleLocalPositionSetpoint__rosidl_typesupport_introspection_c__assign_function__VehicleLocalPositionSetpoint__jerk,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
    "thrust",  // name
