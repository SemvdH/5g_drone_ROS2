...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__SensorCombined__rosidl_typesupport_introspection_c__SensorCombined_message_member_array[9] = {
  {
    "timestamp",  // name
