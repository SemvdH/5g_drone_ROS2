...
size_t px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__size_function__TrajectorySetpoint__thrust(
  const void * untyped_member)
{
  (void)untyped_member;
  return 3;
...
const void * px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_const_function__TrajectorySetpoint__thrust(
  const void * untyped_member, size_t index)
{
  const float * member =
    (const float *)(untyped_member);
...
void * px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_function__TrajectorySetpoint__thrust(
  void * untyped_member, size_t index)
{
  float * member =
    (float *)(untyped_member);
...
void px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__fetch_function__TrajectorySetpoint__thrust(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_const_function__TrajectorySetpoint__thrust(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__assign_function__TrajectorySetpoint__thrust(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_function__TrajectorySetpoint__thrust(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}

static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__TrajectorySetpoint_message_member_array[12] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, vx),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, vy),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, vz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__TrajectorySetpoint, thrust),  // bytes offset in struct
    NULL,  // default value
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__size_function__TrajectorySetpoint__thrust,  // size() function pointer
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_const_function__TrajectorySetpoint__thrust,  // get_const(index) function pointer
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__get_function__TrajectorySetpoint__thrust,  // get(index) function pointer
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__fetch_function__TrajectorySetpoint__thrust,  // fetch(index, &value) function pointer
    px4_msgs__msg__TrajectorySetpoint__rosidl_typesupport_introspection_c__assign_function__TrajectorySetpoint__thrust,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  }
};
