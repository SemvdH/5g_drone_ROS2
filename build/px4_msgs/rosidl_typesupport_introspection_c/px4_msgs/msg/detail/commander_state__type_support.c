...
void CommanderState__rosidl_typesupport_introspection_c__CommanderState_init_function(
...
void CommanderState__rosidl_typesupport_introspection_c__CommanderState_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers CommanderState__rosidl_typesupport_introspection_c__CommanderState_message_members = {
  ...
  CommanderState__rosidl_typesupport_introspection_c__CommanderState_init_function,  // function to initialize message memory (memory has to be allocated)
  CommanderState__rosidl_typesupport_introspection_c__CommanderState_fini_function  // function to terminate message instance (will not free memory)
};
