...
void VehicleAngularVelocityGroundtruth__rosidl_typesupport_introspection_c__VehicleAngularVelocityGroundtruth_init_function(
...
void VehicleAngularVelocityGroundtruth__rosidl_typesupport_introspection_c__VehicleAngularVelocityGroundtruth_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleAngularVelocityGroundtruth__rosidl_typesupport_introspection_c__VehicleAngularVelocityGroundtruth_message_members = {
  ...
  VehicleAngularVelocityGroundtruth__rosidl_typesupport_introspection_c__VehicleAngularVelocityGroundtruth_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleAngularVelocityGroundtruth__rosidl_typesupport_introspection_c__VehicleAngularVelocityGroundtruth_fini_function  // function to terminate message instance (will not free memory)
};
