...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__VehicleImuStatus__rosidl_typesupport_introspection_c__VehicleImuStatus_message_member_array[19] = {
  {
    "timestamp",  // name
