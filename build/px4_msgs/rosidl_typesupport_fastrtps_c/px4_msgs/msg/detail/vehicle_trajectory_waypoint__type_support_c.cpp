...
#include "px4_msgs/msg/detail/vehicle_trajectory_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleTrajectoryWaypoint__ros_msg_type = px4_msgs__msg__VehicleTrajectoryWaypoint;
...
static uint32_t _VehicleTrajectoryWaypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__VehicleTrajectoryWaypoint(
...
{
  return max_serialized_size_px4_msgs__msg__VehicleTrajectoryWaypoint(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, VehicleTrajectoryWaypoint)() {
