...
#include "px4_msgs/msg/detail/estimator_global_position__rosidl_typesupport_fastrtps_c.h"
...
using _EstimatorGlobalPosition__ros_msg_type = px4_msgs__msg__EstimatorGlobalPosition;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EstimatorGlobalPosition__ros_msg_type * ros_message = static_cast<const _EstimatorGlobalPosition__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _EstimatorGlobalPosition__ros_msg_type * ros_message = static_cast<_EstimatorGlobalPosition__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4_msgs__msg__EstimatorGlobalPosition(
  const void * untyped_ros_message,
...
static uint32_t _EstimatorGlobalPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__EstimatorGlobalPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__EstimatorGlobalPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _EstimatorGlobalPosition__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_px4_msgs__msg__EstimatorGlobalPosition(
...
static message_type_support_callbacks_t __callbacks_EstimatorGlobalPosition = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _EstimatorGlobalPosition__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EstimatorGlobalPosition,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, EstimatorGlobalPosition)() {
  return &_EstimatorGlobalPosition__type_support;
}
