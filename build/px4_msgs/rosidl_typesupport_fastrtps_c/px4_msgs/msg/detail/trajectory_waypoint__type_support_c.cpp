...
#include "px4_msgs/msg/detail/trajectory_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryWaypoint__ros_msg_type = px4_msgs__msg__TrajectoryWaypoint;
...
static uint32_t _TrajectoryWaypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__TrajectoryWaypoint(
...
{
  return max_serialized_size_px4_msgs__msg__TrajectoryWaypoint(
    full_bounded, 0);
}
