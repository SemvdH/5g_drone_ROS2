...
#include "px4_msgs/msg/detail/actuator_outputs__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorOutputs__ros_msg_type = px4_msgs__msg__ActuatorOutputs;
...
size_t get_serialized_size_px4_msgs__msg__ActuatorOutputs(
  const void * untyped_ros_message,
...
static uint32_t _ActuatorOutputs__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__ActuatorOutputs(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__ActuatorOutputs(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4_msgs__msg__ActuatorOutputs(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, ActuatorOutputs)() {
