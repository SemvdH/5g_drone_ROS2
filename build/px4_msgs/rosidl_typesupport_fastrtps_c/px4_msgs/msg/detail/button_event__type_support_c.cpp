...
#include "px4_msgs/msg/detail/button_event__rosidl_typesupport_fastrtps_c.h"
...
using _ButtonEvent__ros_msg_type = px4_msgs__msg__ButtonEvent;
...
static uint32_t _ButtonEvent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__ButtonEvent(
...
{
  return max_serialized_size_px4_msgs__msg__ButtonEvent(
    full_bounded, 0);
}
