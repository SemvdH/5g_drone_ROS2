...
#include "px4_msgs/msg/detail/gimbal_manager_set_manual_control__rosidl_typesupport_fastrtps_c.h"
...
using _GimbalManagerSetManualControl__ros_msg_type = px4_msgs__msg__GimbalManagerSetManualControl;
...
static uint32_t _GimbalManagerSetManualControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__GimbalManagerSetManualControl(
...
{
  return max_serialized_size_px4_msgs__msg__GimbalManagerSetManualControl(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, GimbalManagerSetManualControl)() {
