...
#include "px4_msgs/msg/detail/mode_completed__rosidl_typesupport_fastrtps_c.h"
...
using _ModeCompleted__ros_msg_type = px4_msgs__msg__ModeCompleted;
...
size_t get_serialized_size_px4_msgs__msg__ModeCompleted(
  const void * untyped_ros_message,
...
static uint32_t _ModeCompleted__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__ModeCompleted(
...
static size_t _ModeCompleted__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__ModeCompleted(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, ModeCompleted)() {
