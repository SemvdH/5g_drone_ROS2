...
void ActuatorControlsVirtualFw_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) px4_msgs::msg::ActuatorControlsVirtualFw(_init);
}

void ActuatorControlsVirtualFw_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::ActuatorControlsVirtualFw *>(message_memory);
  typed_message->~ActuatorControlsVirtualFw();
}
...
void fetch_function__ActuatorControlsVirtualFw__control(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ActuatorControlsVirtualFw__control(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ActuatorControlsVirtualFw__control(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ActuatorControlsVirtualFw__control(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActuatorControlsVirtualFw_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__ActuatorControlsVirtualFw__control,  // fetch(index, &value) function pointer
    assign_function__ActuatorControlsVirtualFw__control,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ActuatorControlsVirtualFw_message_members = {
  ...
  ActuatorControlsVirtualFw_init_function,  // function to initialize message memory (memory has to be allocated)
  ActuatorControlsVirtualFw_fini_function  // function to terminate message instance (will not free memory)
};
