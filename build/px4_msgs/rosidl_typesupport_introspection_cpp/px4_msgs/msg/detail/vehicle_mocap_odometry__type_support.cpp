...
void fetch_function__VehicleMocapOdometry__q(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleMocapOdometry__q(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleMocapOdometry__q(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleMocapOdometry__q(untyped_member, index));
...
void fetch_function__VehicleMocapOdometry__q_offset(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleMocapOdometry__q_offset(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleMocapOdometry__q_offset(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleMocapOdometry__q_offset(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__VehicleMocapOdometry__pose_covariance(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleMocapOdometry__pose_covariance(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleMocapOdometry__pose_covariance(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleMocapOdometry__pose_covariance(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__VehicleMocapOdometry__velocity_covariance(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleMocapOdometry__velocity_covariance(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleMocapOdometry__velocity_covariance(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleMocapOdometry__velocity_covariance(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleMocapOdometry_message_member_array[18] = {
  ...
  },
  {
    ...
    fetch_function__VehicleMocapOdometry__q,  // fetch(index, &value) function pointer
    assign_function__VehicleMocapOdometry__q,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "q_offset",  // name
    ...
    fetch_function__VehicleMocapOdometry__q_offset,  // fetch(index, &value) function pointer
    assign_function__VehicleMocapOdometry__q_offset,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    fetch_function__VehicleMocapOdometry__pose_covariance,  // fetch(index, &value) function pointer
    assign_function__VehicleMocapOdometry__pose_covariance,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "velocity_frame",  // name
  ...
  },
  {
    ...
    fetch_function__VehicleMocapOdometry__velocity_covariance,  // fetch(index, &value) function pointer
    assign_function__VehicleMocapOdometry__velocity_covariance,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "reset_counter",  // name
