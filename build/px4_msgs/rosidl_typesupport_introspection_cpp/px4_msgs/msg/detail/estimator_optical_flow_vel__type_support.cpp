...
void fetch_function__EstimatorOpticalFlowVel__vel_body(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__EstimatorOpticalFlowVel__vel_body(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__EstimatorOpticalFlowVel__vel_body(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__EstimatorOpticalFlowVel__vel_body(untyped_member, index));
...
void fetch_function__EstimatorOpticalFlowVel__vel_ne(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__EstimatorOpticalFlowVel__vel_ne(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__EstimatorOpticalFlowVel__vel_ne(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__EstimatorOpticalFlowVel__vel_ne(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__EstimatorOpticalFlowVel__flow_uncompensated_integral(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__EstimatorOpticalFlowVel__flow_uncompensated_integral(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__EstimatorOpticalFlowVel__flow_uncompensated_integral(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__EstimatorOpticalFlowVel__flow_uncompensated_integral(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__EstimatorOpticalFlowVel__flow_compensated_integral(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__EstimatorOpticalFlowVel__flow_compensated_integral(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__EstimatorOpticalFlowVel__flow_compensated_integral(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__EstimatorOpticalFlowVel__flow_compensated_integral(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__EstimatorOpticalFlowVel__gyro_rate_integral(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__EstimatorOpticalFlowVel__gyro_rate_integral(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__EstimatorOpticalFlowVel__gyro_rate_integral(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__EstimatorOpticalFlowVel__gyro_rate_integral(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EstimatorOpticalFlowVel_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__EstimatorOpticalFlowVel__vel_body,  // fetch(index, &value) function pointer
    assign_function__EstimatorOpticalFlowVel__vel_body,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "vel_ne",  // name
    ...
    fetch_function__EstimatorOpticalFlowVel__vel_ne,  // fetch(index, &value) function pointer
    assign_function__EstimatorOpticalFlowVel__vel_ne,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    fetch_function__EstimatorOpticalFlowVel__flow_uncompensated_integral,  // fetch(index, &value) function pointer
    assign_function__EstimatorOpticalFlowVel__flow_uncompensated_integral,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    fetch_function__EstimatorOpticalFlowVel__flow_compensated_integral,  // fetch(index, &value) function pointer
    assign_function__EstimatorOpticalFlowVel__flow_compensated_integral,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    fetch_function__EstimatorOpticalFlowVel__gyro_rate_integral,  // fetch(index, &value) function pointer
    assign_function__EstimatorOpticalFlowVel__gyro_rate_integral,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
