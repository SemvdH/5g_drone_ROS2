...
void fetch_function__McVirtualAttitudeSetpoint__q_d(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__McVirtualAttitudeSetpoint__q_d(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__McVirtualAttitudeSetpoint__q_d(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__McVirtualAttitudeSetpoint__q_d(untyped_member, index));
...
void fetch_function__McVirtualAttitudeSetpoint__thrust_body(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__McVirtualAttitudeSetpoint__thrust_body(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__McVirtualAttitudeSetpoint__thrust_body(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__McVirtualAttitudeSetpoint__thrust_body(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember McVirtualAttitudeSetpoint_message_member_array[12] = {
  ...
  },
  {
    ...
    fetch_function__McVirtualAttitudeSetpoint__q_d,  // fetch(index, &value) function pointer
    assign_function__McVirtualAttitudeSetpoint__q_d,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "thrust_body",  // name
    ...
    fetch_function__McVirtualAttitudeSetpoint__thrust_body,  // fetch(index, &value) function pointer
    assign_function__McVirtualAttitudeSetpoint__thrust_body,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
