...
void fetch_function__ControlAllocatorStatus__allocated_torque(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ControlAllocatorStatus__allocated_torque(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ControlAllocatorStatus__allocated_torque(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ControlAllocatorStatus__allocated_torque(untyped_member, index));
...
void fetch_function__ControlAllocatorStatus__allocated_thrust(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ControlAllocatorStatus__allocated_thrust(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ControlAllocatorStatus__allocated_thrust(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ControlAllocatorStatus__allocated_thrust(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlAllocatorStatus_message_member_array[8] = {
  ...
  },
  {
    ...
    fetch_function__ControlAllocatorStatus__allocated_torque,  // fetch(index, &value) function pointer
    assign_function__ControlAllocatorStatus__allocated_torque,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
  ...
  },
  {
    ...
    fetch_function__ControlAllocatorStatus__allocated_thrust,  // fetch(index, &value) function pointer
    assign_function__ControlAllocatorStatus__allocated_thrust,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
