...
void fetch_function__VehicleAttitudeGroundtruth__q(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleAttitudeGroundtruth__q(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleAttitudeGroundtruth__q(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleAttitudeGroundtruth__q(untyped_member, index));
...
void fetch_function__VehicleAttitudeGroundtruth__delta_q_reset(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__VehicleAttitudeGroundtruth__delta_q_reset(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__VehicleAttitudeGroundtruth__delta_q_reset(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__VehicleAttitudeGroundtruth__delta_q_reset(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleAttitudeGroundtruth_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__VehicleAttitudeGroundtruth__q,  // fetch(index, &value) function pointer
    assign_function__VehicleAttitudeGroundtruth__q,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "delta_q_reset",  // name
    ...
    fetch_function__VehicleAttitudeGroundtruth__delta_q_reset,  // fetch(index, &value) function pointer
    assign_function__VehicleAttitudeGroundtruth__delta_q_reset,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
