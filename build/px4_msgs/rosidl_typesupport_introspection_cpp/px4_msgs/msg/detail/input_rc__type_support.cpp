...
{
  new (message_memory) px4_msgs::msg::InputRc(_init);
}

void InputRc_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::InputRc *>(message_memory);
...
void fetch_function__InputRc__values(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__InputRc__values(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__InputRc__values(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__InputRc__values(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InputRc_message_member_array[11] = {
  ...
  },
  {
    ...
    fetch_function__InputRc__values,  // fetch(index, &value) function pointer
    assign_function__InputRc__values,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
