...
#include "px4_msgs/msg/detail/obstacle_distance_fused__type_support.h"
...
static const _ObstacleDistanceFused_type_support_symbol_names_t _ObstacleDistanceFused_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, ObstacleDistanceFused)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, ObstacleDistanceFused)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, msg, ObstacleDistanceFused)() {
  return &::px4_msgs::msg::rosidl_typesupport_c::ObstacleDistanceFused_message_type_support_handle;
}
