...
static const _NormalizedUnsignedSetpoint_type_support_symbol_names_t _NormalizedUnsignedSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, NormalizedUnsignedSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, NormalizedUnsignedSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, msg, NormalizedUnsignedSetpoint)() {
  return &::px4_msgs::msg::rosidl_typesupport_c::NormalizedUnsignedSetpoint_message_type_support_handle;
}
